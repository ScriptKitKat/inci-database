-- Remove catalog copies of original product-label ingredient text.

-- Resolve only canonical names and validated aliases, then compare the
-- resulting ingredient IDs with current product formulas.
...
DROP TABLE IF EXISTS product_ingredient_metadata;
